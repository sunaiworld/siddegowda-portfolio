...
import handlers
from main import run_portfolio_update, build_alert_message, send_telegram
...
async def main():
    ...
    for update in updates:
        ...
        try:
            await bot.send_message(chat_id=chat_id, text=reply, parse_mode=ParseMode.MARKDOWN)
        except Exception:
            # Markdown parse errors shouldn't drop the reply
