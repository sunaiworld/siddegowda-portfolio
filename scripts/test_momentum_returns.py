...
class TestMomentumReturns(unittest.TestCase):
    ...
    def test_column_mapping_integrity(self):
        ...
        # Verify return_1w, return_1m, return_3m placement inside Group 3
        ...
        self.assertLess(GITHUB_DATA_COLS["return_3m"], GITHUB_DATA_COLS[end_key])

    def test_live_fetch_stock_and_etf(self):
        """Fetch technicals for normal stock and ETF and verify 1W / 1M / 3M returns."""
        for sym in ["RELIANCE", "NIFTYBEES", "TCS"]:
            ...
            print(f"[{sym}] 1W Return: {ret1w} | 1M Return: {ret1m} | 3M Return: {ret3m}")
    ...
    def test_build_result_row_structure(self):
        """Verify build_result_row puts return_1w, return_1m, return_3m into correct row indices."""
        sym = "TESTSYM"
        cmp = 100.0
        ...
        tech = {
            ...
            "cross": "", "day_chg_pct": 1.5, "return_1w": 3.45, "return_1m": -2.10, "return_3m": 5.75
        }
        rev_gr = 12.5
    ...
    def test_missing_insufficient_history(self):
        ...
        cmp = 50.0
        f = {}
        tech = {"day_chg_pct": 0.0, "return_1w": "", "return_1m": "", "return_3m": ""}
