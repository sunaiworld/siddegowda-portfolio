...
WATCHLISTS = {
    "Future Buy": [
        ...
        "PIDILITIND", "ABB", "ABCAPITAL", "ABSLAMC", "AMBUJACEM",
        "BANKBARODA", "CHOLAFIN", "COLPAL", "GODREJCP", "GRASIM",
        "INDUSTOWER", "JINDALSTEL", "MOTHERSON", "SAIL", "SBICARD",
        "SBILIFE", "SBIN", "SCHNEIDER", "TATACHEM", "TATAPOWER",
        "TITAN", "TORNTPHARM", "TRENT", "TVSMOTOR", "ULTRACEMCO",
        "WELCORP",
    ],
}
